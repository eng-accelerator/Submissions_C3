...
def log_reader_agent(state: dict, api_key: str):
    ...
    prompt = ChatPromptTemplate.from_messages([
        ...
        ("user", "Analyze the following log content. If it contains multiple log entries, analyze ALL of them.\n\n{log_content}\n\nReturn a JSON object with a single key 'findings', which is a list of objects. Each object in the list should have: 'error_type', 'timestamp', 'summary', 'severity', 'stack_trace_summary'.")
    ])
